...
![0](/assets/images/inline_height_draw.png)
...
![0](/assets/images/background_color.png)
...
![0](/assets/images/background_ex_full.png)

![0](/assets/images/background_ex_small.png)
...
![0](/assets/images/background_ex_overflow.png)

article에 background-attachment: fixed 속성을 넣어볼까? 그럼 article 태그는 어느 태그에 종속되어있든 상관하지 않고, 무조건 웹브라우저 기준으로 고정된다.

![0](/assets/images/background_ex_fixed_full.png)

![0](/assets/images/background_ex_fixed_small.png)

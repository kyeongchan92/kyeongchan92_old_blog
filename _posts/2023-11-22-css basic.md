...
![0](/assets/images/css basic/css basic/margin_body.png)
...
.wrap이 자식 요소의 높잇값을 인식하지 못했다! 테두리를 감싸지 못했다. 자식 블록 요소에 float를 적용시키면 부모 요소는 자식 요소의 높이를 인식하지 못한다.
...
- relative : 현재 위칫값을 기준으로 상대 위치를 지정
...
![0](/assets/images/css basic/layout_f---
title: CSS 기초
description:
categories:
tags:
...
bottom에 float를 적용하지 않으면...?

![0](/assets/images/css basic/layout_position_absolute_float.png)

부모는 bottom의 높이를 인식하지 못한다.
